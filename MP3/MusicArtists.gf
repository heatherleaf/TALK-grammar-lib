...
fifty_cent		: Artist;
garbage 		: Artist;
god_speed_black_emperor : Artist;
green_day 		: Artist;
guns_and_roses 		: Artist;
jam 			: Artist;
jessica_simpson 	: Artist;
justin_timberlake       : Artist;
kate_bush 		: Artist;
led_zeppelin 		: Artist;
lee_morgan 		: Artist;
madonna 		: Artist;
