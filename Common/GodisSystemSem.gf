...
concrete GodisSystemSem of GodisSystem = GodisCatSem ** open Prolog in {
...
icm_accommodate   = icmSingle0 "accommodate";
...
icm_und_pos_negvp   p = icmFeedback1 "und" "pos" (pOper "*" (pp0 "usr") (pp1 "not" p));
icm_und_int_negvp   p = icmFeedback1 "und" "int" (pOper "*" (pp0 "usr") (pp1 "not" p));

icm_reraise_act       = icmSingle1 "reraise";
icm_accommodate_act   = icmSingle1 "accommodate";
icm_reaccommodate_act = icmSingle1 "reaccommodate";
...
icm_accommodate_whq    = icmSingle1 "accommodate";
icm_accommodate_ynq    = icmSingle1 "accommodate";
icm_accommodate_altq   = icmSingle1 "accommodate";
icm_reaccommodate_whq  = icmSingle1 "reaccommodate";
icm_reaccommodate_ynq  = icmSingle1 "reaccommodate";
icm_reaccommodate_altq = icmSingle1 "reaccommodate";
