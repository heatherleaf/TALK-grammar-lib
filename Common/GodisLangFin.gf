...
userPardon = variants{ ss "ursäkta" };
...
what_did_you_say       = mkUtt ["Mitä sanoitte"];
what_do_you_mean       = mkUtt ["Mitä tarkoitatte"];
...
icm_per_pos   x = mkUtt (["Luulin että sanoitte että"] ++ x.s);
