...
am = sing_NP (variants {["på förmiddagen"];
                        ["förmiddagen"];
                        ["på morgonen"];
                        ["morgon"];
                        ["före lunch"];
...
pm = sing_NP (variants {["på eftermiddagen"];
                        ["eftermiddagen"];
                        ["på kvällen"];
                        ["kvällen"];
                        ["kväll"];
...
seven = sing_NP ["sju"];
seven_thirty = sing_NP ["halv åtta"];
eight = sing_NP ["åtta"];
...
twentytwo = sing_NP ["tjugotvå"];
twentytwo_thirty = sing_NP ["tjugotvå trettio"];
